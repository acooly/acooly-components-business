...
<div class="easyui-layout" data-options="fit : true,border : false">
    ...
    <div data-options="region:'center',border:false">
        ...
        <div id="manage_pointTrade_toolbar">
            ...
            <!--         <div onclick="$.acooly.framework.exports('/manage/point/pointTrade/exportXls.html','manage_pointTrade_searchform','${pointModuleName}交易信息')"><i class="fa fa-file-excel-o fa-lg fa-fw fa-col"></i>Excel</div> -->
            <!--         <div onclick="$.acooly.framework.exports('/manage/point/pointTrade/exportCsv.html','manage_pointTrade_searchform','${pointModuleName}交易信息')"><i class="fa fa-file-text-o fa-lg fa-fw fa-col"></i>CSV</div> -->
            <!--       </div> -->
