...
<div align="center">
    <table class="tableForm" width="100%">
        ...
        <tr>
            ...
            <td>
                <div id="manage_pointStatistics_import_uploader_message" style="color: red;"></div>
            </td>
        </tr>
        <tr>
            <th width="30%">文件：</th>
            <td>
                <input type="file" name="manage_pointStatistics_import_uploader_file" id="manage_pointStatistics_import_uploader_file"/>
            </td>
        </tr>
    </table>
</div>
