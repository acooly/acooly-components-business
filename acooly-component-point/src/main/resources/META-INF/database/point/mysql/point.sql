...
-- ----------------------------
INSERT INTO `point_grade` VALUES ('1', '1', '等级1', '0', '10000000', '2015-12-28 18:46:34', '2016-01-11 18:40:53', '/assets/images/grade/1.png', '');
INSERT INTO `point_grade` VALUES ('2', '2', '等级2', '10000001', '30000000', '2015-12-28 18:47:09', '2016-01-11 18:39:03', '/assets/images/grade/2.png', '');
INSERT INTO `point_grade` VALUES ('3', '3', '等级3', '30000001', '50000000', '2015-12-28 18:47:42', '2016-01-11 18:38:57', '/assets/images/grade/3.png', '');
INSERT INTO `point_grade` VALUES ('4', '4', '等级4', '50000001', '999999999', '2015-12-28 19:38:21', '2016-12-25 15:00:13', '/assets/images/grade/4.png', '');
INSERT INTO `point_grade` VALUES ('5', '5', '等级5', '100000000', '999999999', '2015-12-30 15:42:27', '2017-02-04 01:17:51', '/assets/images/grade/5.png', '');
...
CREATE TABLE `point_type_count` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `user_name` varchar(32) NOT NULL COMMENT '用户名',
  `num` bigint(20) NOT NULL DEFAULT '0' COMMENT '统计次数',
  `busi_type` varchar(32) NOT NULL COMMENT '业务类型',
  `busi_type_text` varchar(32) NOT NULL COMMENT '业务类型描述',
  `total_point` bigint(20) NOT NULL DEFAULT '0' COMMENT '总积分',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  `memo` varchar(256) DEFAULT NULL COMMENT '备注',
  PRIMARY KEY (`id`),
  UNIQUE KEY `acc_username_idx` (`user_name`,`busi_type`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='积分业务统计';
