        ...
        <jodd:form bean="pointTrade" scope="request">
            ...
            <table class="tableForm" width="100%">
                <tr>
                    ...
                    <td><input type="text" name="tradeNo" size="48" class="easyui-validatebox text" data-options="required:true"
                ...
                <tr>
                    ...
                    <td><input type="text" name="accountId" size="48" class="easyui-numberbox text" data-options="required:true"
                               validType="byteLength[1,19]"/></td>
                </tr>
                <tr>
                    <th>交易${pointModuleName}：</th>
                    <td><input type="text" name="amount" size="48" class="easyui-numberbox text" data-options="required:true"
                               validType="byteLength[1,19]"/></td>
                </tr>
                <tr>
                    <th>交易后${pointModuleName}：</th>
                    <td><input type="text" name="balance" size="48" class="easyui-numberbox text" data-options="required:true"
                               validType="byteLength[1,19]"/></td>
                </tr>
                <tr>
                    <th>相关业务数据：</th>
                    <td><textarea rows="3" cols="40" style="width:300px;" name="businessData" class="easyui-validatebox"
