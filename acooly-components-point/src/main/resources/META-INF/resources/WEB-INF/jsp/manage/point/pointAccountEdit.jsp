...
<div>
    <form id="manage_pointAccount_editform"
          action="${pageContext.request.contextPath}/manage/point/pointAccount/${action=='create'?'saveJson':'updateJson'}.html"
          method="post">
        <jodd:form bean="pointAccount" scope="request">
            ...
            <table class="tableForm" width="100%">
                ...
                <tr>
                    <th>冻结：</th>
                    <td><input type="text" name="freeze" size="48" class="easyui-numberbox text" data-options="required:true"
                               validType="byteLength[1,19]"/></td>
                </tr>
                <tr>
                    <th>状态：</th>
                ...
                <tr>
                    <th>用户等级：</th>
                    <td><input type="text" name="gradeId" size="48" class="easyui-numberbox text" data-options="required:true"
