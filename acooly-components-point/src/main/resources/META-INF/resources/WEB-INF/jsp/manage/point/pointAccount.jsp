...
<div class="easyui-layout" data-options="fit : true,border : false">
                ...
                <tr>
                    <td align="left">
                        <div>
                            ...
                            用户等级: <select style="width:80px;height:27px;" name="search_EQ_gradeId" editable="false" panelHeight="auto"
    ...
    <div data-options="region:'center',border:false">
        <table id="manage_pointAccount_datagrid" class="easyui-datagrid"
               url="${pageContext.request.contextPath}/manage/point/pointAccount/listJson.html" toolbar="#manage_pointAccount_toolbar"
            ...
            <tr>
                ...
                <th field="balance" sum="true">${pointModuleName}余额</th>
                <th field="freeze" sum="true">冻结${pointModuleName}</th>
                <th field="available" sum="true">有效${pointModuleName}</th>
                <th field="totalExpensePoint" sum="true">总消费${pointModuleName}</th>
                <th field="totalProducePoint" sum="true">总产生${pointModuleName}</th>
                <th field="status"
                    data-options="formatter:function(value){ return formatRefrence('manage_pointAccount_datagrid','allStatuss',value);} ">状态
                </th>
                <th field="gradeId"
                    data-options="formatter:function(value){ return formatRefrence('manage_pointAccount_datagrid','allPointGrades',value);} ">
                    用户等级
                </th>
        ...
        <div id="manage_pointAccount_action" style="display: none;">
            ...
            <a onclick="$.acooly.framework.show('/manage/point/pointAccount/show.html?id={0}',500,400);" href="#" title="查看"><i
        ...
        <div id="manage_pointAccount_toolbar">
            ...
            <a href="#" class="easyui-linkbutton" plain="true"
               onclick="$.acooly.framework.create({url:'/manage/point/pointAccount/grant.html',entity:'pointAccount',width:500,height:400,addButton:'${pointModuleName}发放',reload:true})"><i
                    class="fa fa-plus-circle fa-lg fa-location-arrow fa-col"></i>${pointModuleName}发放</a>
            <a href="#" class="easyui-linkbutton" plain="true"
               onclick="$.acooly.framework.imports({url:'/manage/point/pointAccount/importView.html',uploader:'manage_pointAccount_import_uploader_file',width:500,height:400,});"><i
                    class="fa fa-arrow-circle-o-up fa-lg fa-fw fa-col"></i>导入文件发放</a>
