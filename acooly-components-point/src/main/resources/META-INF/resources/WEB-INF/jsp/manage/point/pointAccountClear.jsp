...
<div>
    <form id="manage_pointAccount_editform" action="${pageContext.request.contextPath}/manage/point/pointAccount/clearJson.html"
          method="post">
        <table class="tableForm" width="100%">
            <tr>
                <th>提示：</th>
                <td>${pointModuleName}清零不可恢复,请小心操作</td>
            </tr>
            <tr>
                <th>清零开始时间：</th>
